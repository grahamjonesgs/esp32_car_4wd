...
void tft_output_t(void * pvParameters ) {
  ...
  tft.drawString("Car RPM", CAR_STATUS_LEFT, CAR_STATUS_TOP + CAR_STATUS_GAP * 5, 2);
  ...
  while (true) {
    ...
    tft.drawString(String(RPM) + "   ", CAR_STATUS_LEFT + 105, CAR_STATUS_TOP + CAR_STATUS_GAP * 5 , 2);
